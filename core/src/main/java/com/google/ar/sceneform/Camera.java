...
public class Camera extends Node implements CameraProvider {
  ...
  private static final int FALLBACK_VIEW_WIDTH = 1040;
  private static final int FALLBACK_VIEW_HEIGHT = 1040;

  // Default vertical field of view for non-ar camera.
  private static final float DEFAULT_VERTICAL_FOV_DEGREES = 60.0f;
